package com.example.jungho.advice;


import com.example.jungho.advice.exception.CAuthenticationEntryPointException;
...
@RequiredArgsConstructor //final 로 선언된 것 autoInjection 해주는 annotation
